...
function ServiceTabs({ services, activeService, onSelect }: {
    ...
    return (
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-3 md:gap-2 pb-6 md:pb-6 pt-2">
            {services.map((s) => {
                ...
                return (
                    <button
                        ...
                        title={s.label}
                        className={`flex flex-col items-center justify-center gap-1.5 aspect-square rounded-full border transition-all duration-300 focus:outline-none group min-w-[76px] md:min-w-[80px] w-full max-w-[90px] mx-auto flex-shrink-0 relative z-10 p-2
                            ${isActive
